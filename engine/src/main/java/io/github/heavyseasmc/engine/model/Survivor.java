 ...
 *   <li>航海牌点名的倾向。❗<b>这一条实测没有前三条那么硬</b>：2 万局模拟下来，
 *       落水频率与体型只是<b>弱相关</b>（r≈0.40–0.65，随舵手挑牌的取向而变），
 *       真实结构是<b>八个角色里六个被点到的张数完全相同</b>，只有珠宝商与陪酒女更少；
 *       反倒是<b>口渴</b>与体型强相关（r≈0.93）且三种取向下都稳。
 *       改数值时别把「落水随体型上升」当成既有前提 —— 它现在更像是口渴那一栏的性质。</li>
 * </ol>
 *
